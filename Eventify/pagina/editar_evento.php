...
<body>
    <main style="padding-top: 5rem; padding-bottom: 5rem;" class="container mt-4">
        ...
        <form method="post" class="needs-validation" novalidate enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="descripcion" name="descripcion" required><?= htmlspecialchars($evento['Descripcion']); ?></textarea>
            </div>
            <div class="mb-3">
                <label for="fecha" class="form-label">Fecha:</label>
                <input type="datetime-local" class="form-control" id="fecha" name="fecha" value="<?= date('Y-m-d\TH:i', strtotime($evento['Fecha'])); ?>" required>
            </div>
            <div class="mb-3">
                <label for="ubicacion" class="form-label">Ubicación:</label>
                <input type="text" class="form-control" id="ubicacion" name="ubicacion" value="<?= htmlspecialchars($evento['Ubicacion']); ?>" required>
            </div>
            <div class="mb-3">
                <div id="map"></div>
                <label for="costo" class="form-label">Costo:</label>
                <input type="number" class="form-control" id="costo" name="costo" step="0.01" value="<?= htmlspecialchars($evento['Costo_entrada']); ?>" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <?php if (!empty($evento['Imagen_evento'])): ?>
                    <img src="mostrar_imagen.php?id=<?= $evento['ID_evento']; ?>" alt="Imagen actual del evento" class="mt-2" style="max-width: 200px;">
