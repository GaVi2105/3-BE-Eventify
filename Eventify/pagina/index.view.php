        ...
        <div id="carouselExampleCaptions" class="carousel slide">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img style="height: 400px;" src="imagenes/ITSP FRENTE.jpg" class="d-block w-100" alt="...">
                ...
                <div class="carousel-item">
                    <img style="height: 400px;" src="imagenes/paysandu.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Titulo</h5>
                        <p>Parrafo</p>
                    </div>
                ...
                <div class="carousel-item">
                    <img style="height: 400px;" src="imagenes/itsp.jpeg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Titulo</h5>
                        <p>Parrafo</p>
                    </div>
        ...
        <div id="carouselExampleDark" class="carousel carousel-dark slide">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="10000">
                    <img style="height: 200px;" src="imagenes/generica.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
